...
.root[label-size$="small"] [kube-item="field"] { max-width: calc(100% - 80px); }

.root[label-size$="large"] [kube-item="label"] > label{ width: 160px; padding-right: 20px; }
.root[label-size$="large"] [kube-item="label"] > label::after { right: 2px; }
.root[label-size$="large"] [kube-item="field"] { max-width: calc(100% - 160px); }

.root[label-size$="normal"] [kube-item="label"] > label{ width: 120px; padding-right: 20px; }
.root[label-size$="normal"] [kube-item="label"] > label::after { right: 2px; }
.root[label-size$="normal"] [kube-item="field"] { max-width: calc(100% - 120px); }
